    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <div class="alert alert-dismissable alert-success">
                ...
                <h4>
                    欢迎!
                </h4>尊贵的用户${user.name} <a href="/admin/user/exitLogin" class="alert-link">退出</a>
            </div>
        </div>
    </div>
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover table-bordered">
                ...
                <c:forEach items="${categories}" var="c" varStatus="st">
                    <tr>
                        <td>${c.id}</td><td><a href="/admin/product/list?id=${c.id}">${c.name}</a></td>
                        <td>
                        ...
                        <td>
                            <button type="button" class="btn btn-default btn-danger delete-btn"
                                    name="/admin/category/delete?id=${c.id}" >删除</button>
                        </td>
                        <td>
                            <a href="/admin/property/list?id=${c.id}">
            ...
            <table class="table table-bordered table-condensed">
                <tr>
                    <th><a href="/admin/category/list?start=0">首页</a></th>
                    <th><a href="/admin/category/list?start=${page.start-page.count}">上一页</a></th>
                    <th><a href="/admin/category/list?start=${page.start+page.count}">下一页</a></th>
                    <th><a href="/admin/category/list?start=${page.end}">尾页</a></th>
                </tr>
            </table>
        </div>
    </div>
