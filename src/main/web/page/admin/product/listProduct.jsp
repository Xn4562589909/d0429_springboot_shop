        ...
        <div class="col-md-12 column">
            ...
            <c:if test="${products.size()!=0}">
                <table class="table table-hover table-bordered">
                    ...
                    <c:forEach items="${products}" var="p" varStatus="st" >
                        <tr>
                            ...
                            <td>
                                <a href="/admin/product/edit?id=${p.id}">
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-danger delete-btn"
                                        name="/admin/product/delete?id=${p.id}" >删除</button>
                            </td>
                            <td>
                                <a href="/admin/productImage/list?id=${p.id}">
                                    <button type="button" class="btn btn-default btn-info">管理图片</button>
                                </a>
                            </td>
                            <td>
                                <a href="/admin/propertyValue/list?id=${p.id}">
                ...
                <table class="table table-bordered table-condensed">
                    <tr>
                        <th><a href="/admin/product/list?start=0&id=${cid}">首页</a></th>
                        <th><a href="/admin/product/list?start=${page.start-page.count}&id=${cid}">上一页</a></th>
                        <th><a href="/admin/product/list?start=${page.start+page.count}&id=${cid}">下一页</a></th>
                        <th><a href="/admin/product/list?start=${page.end}&id=${cid}">尾页</a></th>
                    </tr>
                </table>
            </c:if>
        </div>
