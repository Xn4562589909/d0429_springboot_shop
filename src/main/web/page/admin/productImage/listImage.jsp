...
<div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger delete-image"
                                    name="/admin/productImage/delete?id=${pi.id}">删除
                            </button>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form role="form" action="/admin/productImage/add" method="post">
                <div class="form-group">
                    <input type="hidden" class="form-control" value="${product.id}" name="pid" />
                </div>
                <div class="form-group">
                    <label for="piUrl">请输入图片url</label><input type="text" class="form-control" id="piUrl" name="url" />
                </div>
