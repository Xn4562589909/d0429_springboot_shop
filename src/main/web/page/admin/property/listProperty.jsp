...
<div class="container">
        ...
        <div class="col-md-12 column">
            ...
            <c:if test="${pts.size()!=0}">
                <table class="table table-hover table-bordered">
                    ...
                    <c:forEach items="${pts}" var="pt" varStatus="st">
                        <tr>
                            ...
                            <td>${pt.name}</td>
                            <td>
                                <a href="/admin/property/edit?id=${pt.id}">
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-danger delete-btn"
                                        name="/admin/property/delete?id=${pt.id}">删除</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                ...
                <table class="table table-bordered table-condensed">
                    <tr>
                        <th><a href="/admin/property/list?start=0&id=${cid}">首页</a></th>
                        <th><a href="/admin/property/list?start=${page.start-page.count}&id=${cid}">上一页</a></th>
                        <th><a href="/admin/property/list?start=${page.start+page.count}&id=${cid}">下一页</a></th>
                        <th><a href="/admin/property/list?start=${page.end}&id=${cid}">尾页</a></th>
                    </tr>
                </table>
            </c:if>
        </div>
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form class="form-horizontal" role="form" action="/admin/property/add" method="post">
