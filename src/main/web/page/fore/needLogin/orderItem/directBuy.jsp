...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <c:if test="${empty orderItems}" >
                <form role="form" action="/fore/order/add" method="post">
                    <div class="form-group">
            ...
            <c:if test="${!empty orderItems}" >
                <form role="form" action="/fore/order/addByCar" method="post">
                    <div class="form-group">
                        <input type="hidden" class="form-control" value="${orderItems.get(0).order.id}" name="id" />
                    </div>
                    <div class="form-group">
