    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <h3 class="text-success text-left">
                为您查询到${products.size()}条结果
            </h3>
            <span><a href="/fore/foreProduct/nameList?searchProduct=${searchNameProduct}&sort=price">价格排序</a></span>
            <span><a href="/fore/foreProduct/nameList?searchProduct=${searchNameProduct}&sort=sale">销量排序</a></span>
            <span><a href="/fore/foreProduct/nameList?searchProduct=${searchNameProduct}&sort=reviewCount">评价数量排序</a></span>
            <hr>
        </div>
    </div>
    <div class="row clearfix">
