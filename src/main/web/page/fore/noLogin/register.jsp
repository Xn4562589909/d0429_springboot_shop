...
<div class="container">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-4 column">
            <form role="form" action="/fore/user/register" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">注册用户:</label><input type="text" class="form-control" name="name" id="exampleInputEmail1" />
                </div>
                <div class="form-group">
