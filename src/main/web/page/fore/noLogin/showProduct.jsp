...
<div class="container" >
        ...
        <div class="col-md-12 column">
            <nav class="navbar navbar-default navbar-inverse" role="navigation">
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <form class="navbar-form navbar-left" role="search" action="/fore/foreProduct/list" method="get">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-6 column" style="margin-top: 40px;">
            ...
            <form role="form" action="/fore/orderItem/directBuy" method="get" style="width: 235px;height: 45px;margin-left: 120px;margin-top: 75px">
                <div class="form-group" >
...
<script>
    $("#joinCar").click(function () {
        ...
        let url = "/fore/orderItem/joinCar";
        $.post(
            url,
            {"productId":productId,
